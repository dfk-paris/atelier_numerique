...
Bienvenue à Paris chère voyageuse, cher voyager! 
Hier finden Sie den Ablaufplan, Informationen zu Daten, Ansprechpartner:innen und Beispiele für unser Atelier Numérique im Rahmen der [vDHd 2021](https://vdhd2021.hypotheses.org/).

Und falls Sie noch keine Bordkarte haben, dann geht es hier direkt zur Ausgabe !  [https://pretix.eu/dfk-paris.org/hackathon/](https://pretix.eu/dfk-paris.org/hackathon/)


Literatur ? [Das Atelier in der Zotero-Bibliografie der vDHd2021 ](https://www.zotero.org/groups/2785027/vdhd2021/collections/D9NETN2A)
...
| 13:00-16:00  Input zu [IIIF](https://iiif.io/), [Leaflet.js](https://leafletjs.com/), [Openrefine](https://openrefine.org/) |
...
* Wissenschaftliche Leitung der Überarbeitung: [Dr. Anne Klammt](https://dfk-paris.org/de/person/anne-klammt-2597.html), DFK Paris
...
* Sammlung von Quellen (Zusammenfassungen von Presseartikeln und Präsentationen von Kunstzeitschriften), eine Chronologie der Ausstellungen, Interviews mit Zeitzeugen und Fallstudien.

##### Daten 

Für das Atelier haben wir die strukturierten Daten normalisiert und einfacher nutzbar gemacht:

* **Personen mit Wikidata / ULAN /GND / BnBf / ViaF** [als **xlsx**: https://github.com/dfk-paris/atelier_numerique/blob/gh_pages/Transfair_people.xlsx](https://github.com/dfk-paris/atelier_numerique/blob/gh_pages/Transfair_people.xlsx) als [**JSON** : https://github.com/dfk-paris/atelier_numerique/blob/gh_pages/Transfair_people.json](https://github.com/dfk-paris/atelier_numerique/blob/gh_pages/Transfair_people.json)

* strukturierte Quellenerhebung von: **Ausstellungen / Beteiligte Künstler:innen / Ausstellungsorte / Gruppen und Verbände / Orte** [als **xlsx**:  https://github.com/dfk-paris/atelier_numerique/blob/gh_pages/Transfair_sources.xlsx](https://github.com/dfk-paris/atelier_numerique/blob/gh_pages/Transfair_sources.xlsx) [als **JSON:** https://github.com/dfk-paris/atelier_numerique/blob/gh_pages/Transfair_sources.json](https://github.com/dfk-paris/atelier_numerique/blob/gh_pages/Transfair_sources.json)

Die Daten sind über heiDATA publiziert.

ZITATION ! Mathilde Arnoux, »OwnReality. To Each His Own Reality [Research Data]«, heiDATA, 2020, [https://doi.org/10.11588/DATA/ZMIHMY](https://doi.org/10.11588/DATA/ZMIHMY). 
